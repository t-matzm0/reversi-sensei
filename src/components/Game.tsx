...
export default function Game() {
  ...
  const { showHints, isVsComputer, difficulty, toggleHints, toggleGameMode, setDifficulty } = useGameSettings();
  
  const handleAIMove = useCallback((board: Board, nextPlayer: 'black' | 'white', move: { row: number; col: number }) => {
    setLastMove(move);
